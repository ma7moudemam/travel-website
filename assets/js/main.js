...
sr.reveal(`.home__data, .home__socail-link, .home__info , .discover__container,
            .experience__data , .experience__overlay, .place__card,
            .sponsor__content, .footer__rights , .footer__data`,{
    origin:'top',
    interval:100,
